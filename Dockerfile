...
RUN mkdir -p /app/backend/uploads/applicants /app/backend/uploads/master /app/backend/uploads/generated /app/backend/uploads/signatures

EXPOSE 3000

CMD ["sh", "-c", "mkdir -p /app/backend/uploads/applicants /app/backend/uploads/master /app/backend/uploads/generated /app/backend/uploads/signatures && npx prisma migrate deploy && node prisma/seed.js && node dist/src/main"]
