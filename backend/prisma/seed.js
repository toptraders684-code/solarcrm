...
async function main() {
  ...
  if (existingDocMasterCount > 0) {
    ...
    const docMasters = [
      // ── TPCODL ──
      { discom: 'tpcodl', title: 'Aadhaar, PAN Card And Bank Passbook Front Page', docType: 'upload', sortOrder: 1 },
      { discom: 'tpcodl', title: 'Adani Data Sheet', docType: 'upload', sortOrder: 2 },
      { discom: 'tpcodl', title: 'Adani Eastman Datasheet', docType: 'upload', sortOrder: 3 },
      { discom: 'tpcodl', title: 'Customer Vendor Agreement', docType: 'generate', sortOrder: 4 },
      { discom: 'tpcodl', title: 'DCR Certificate', docType: 'upload', sortOrder: 5 },
      { discom: 'tpcodl', title: 'Declaration For DCR', docType: 'generate', sortOrder: 6 },
      { discom: 'tpcodl', title: 'Digital Approval, Feasibility Report And Quotation', docType: 'upload', sortOrder: 7 },
      { discom: 'tpcodl', title: 'Electricity Bill A4 Size Copy', docType: 'upload', sortOrder: 8 },
      { discom: 'tpcodl', title: 'Form-1 Application Form Net Meter', docType: 'generate', sortOrder: 9 },
      { discom: 'tpcodl', title: 'Form-3 Work Complete', docType: 'generate', sortOrder: 10 },
      { discom: 'tpcodl', title: 'Generated File JEE Sign', docType: 'generate', sortOrder: 11 },
      ...
      { discom: 'tpnodl', title: 'PAN Card', docType: 'upload', sortOrder: 2 },
      { discom: 'tpnodl', title: 'Bank Passbook Front Page', docType: 'upload', sortOrder: 3 },
      { discom: 'tpnodl', title: 'Electricity Bill (A4 Size)', docType: 'upload', sortOrder: 4 },
      { discom: 'tpnodl', title: 'Customer Agreement', docType: 'generate', sortOrder: 5 },
      { discom: 'tpnodl', title: 'Technical Feasibility Report', docType: 'upload', sortOrder: 6 },
      { discom: 'tpnodl', title: 'Application Form (Form-1)', docType: 'generate', sortOrder: 7 },
      { discom: 'tpnodl', title: 'DCR Certificate', docType: 'upload', sortOrder: 8 },
      { discom: 'tpnodl', title: 'GST Tax Invoice', docType: 'generate', sortOrder: 9 },
      { discom: 'tpnodl', title: 'Installation Photos', docType: 'upload', sortOrder: 10 },
      { discom: 'tpnodl', title: 'Site Survey Report', docType: 'upload', sortOrder: 11 },
      { discom: 'tpnodl', title: 'DISCOM Approval Letter', docType: 'upload', sortOrder: 12 },
      { discom: 'tpnodl', title: 'Net Meter Agreement', docType: 'generate', sortOrder: 13 },
      { discom: 'tpnodl', title: 'Joint Inspection Report', docType: 'upload', sortOrder: 14 },
      { discom: 'tpnodl', title: 'Geo Tag Photos', docType: 'upload', sortOrder: 15 },
      { discom: 'tpnodl', title: 'Inverter Datasheet', docType: 'upload', sortOrder: 16 },
      { discom: 'tpnodl', title: 'Panel Datasheet', docType: 'upload', sortOrder: 17 },
      { discom: 'tpnodl', title: 'Work Completion Certificate', docType: 'generate', sortOrder: 18 },
      // ── TPSODL ──
      { discom: 'tpsodl', title: 'Aadhaar Card', docType: 'upload', sortOrder: 1 },
      { discom: 'tpsodl', title: 'PAN Card', docType: 'upload', sortOrder: 2 },
      { discom: 'tpsodl', title: 'Bank Account Details', docType: 'upload', sortOrder: 3 },
      { discom: 'tpsodl', title: 'Electricity Bill', docType: 'upload', sortOrder: 4 },
      { discom: 'tpsodl', title: 'Customer Consent Form', docType: 'generate', sortOrder: 5 },
      { discom: 'tpsodl', title: 'Application Form', docType: 'generate', sortOrder: 6 },
      { discom: 'tpsodl', title: 'Site Survey Report', docType: 'upload', sortOrder: 7 },
      { discom: 'tpsodl', title: 'DCR Certificate', docType: 'upload', sortOrder: 8 },
      { discom: 'tpsodl', title: 'Technical Design Drawing (SLD)', docType: 'upload', sortOrder: 9 },
      { discom: 'tpsodl', title: 'DISCOM Portal Screenshot', docType: 'upload', sortOrder: 10 },
      { discom: 'tpsodl', title: 'Feasibility Report', docType: 'upload', sortOrder: 11 },
      { discom: 'tpsodl', title: 'Installation Completion Certificate', docType: 'generate', sortOrder: 12 },
      { discom: 'tpsodl', title: 'Net Meter Agreement', docType: 'generate', sortOrder: 13 },
      { discom: 'tpsodl', title: 'Commissioning Certificate', docType: 'upload', sortOrder: 14 },
      { discom: 'tpsodl', title: 'GST Invoice', docType: 'generate', sortOrder: 15 },
      { discom: 'tpsodl', title: 'Work Completion Certificate', docType: 'generate', sortOrder: 16 },
      { discom: 'tpsodl', title: 'Geo Tag Photos', docType: 'upload', sortOrder: 17 },
      // ── TPWODL ──
      { discom: 'tpwodl', title: 'Aadhaar & PAN Card', docType: 'upload', sortOrder: 1 },
      { discom: 'tpwodl', title: 'Bank Passbook Copy', docType: 'upload', sortOrder: 2 },
      { discom: 'tpwodl', title: 'Electricity Bill (Latest)', docType: 'upload', sortOrder: 3 },
      { discom: 'tpwodl', title: 'Customer Agreement', docType: 'generate', sortOrder: 4 },
      { discom: 'tpwodl', title: 'DCR Certificate', docType: 'upload', sortOrder: 5 },
      { discom: 'tpwodl', title: 'Technical Drawing (SLD)', docType: 'upload', sortOrder: 6 },
      { discom: 'tpwodl', title: 'Application Form', docType: 'generate', sortOrder: 7 },
      { discom: 'tpwodl', title: 'DISCOM Approval Letter', docType: 'upload', sortOrder: 8 },
      { discom: 'tpwodl', title: 'Site Survey Photos', docType: 'upload', sortOrder: 9 },
      { discom: 'tpwodl', title: 'Installation Photos', docType: 'upload', sortOrder: 10 },
      { discom: 'tpwodl', title: 'Joint Inspection Report', docType: 'upload', sortOrder: 11 },
      { discom: 'tpwodl', title: 'Net Meter Certificate', docType: 'upload', sortOrder: 12 },
      { discom: 'tpwodl', title: 'GST Tax Invoice', docType: 'generate', sortOrder: 13 },
      { discom: 'tpwodl', title: 'Work Completion Certificate', docType: 'generate', sortOrder: 14 },
      { discom: 'tpwodl', title: 'Commissioning Certificate', docType: 'upload', sortOrder: 15 },
      { discom: 'tpwodl', title: 'Warranty Cards', docType: 'upload', sortOrder: 16 },
    ];
